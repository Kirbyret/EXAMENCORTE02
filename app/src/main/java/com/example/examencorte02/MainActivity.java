...
public class MainActivity extends AppCompatActivity {
    ...
    private void realizarVenta() {
        ...
        int capacidadBomba = Integer.parseInt(txtCapacidad.getText().toString().trim());
        int capacidadRestante = capacidadBomba - contadorLitros;

        if (cantidad > capacidadRestante) {
            Toast.makeText(MainActivity.this, "La cantidad solicitada excede la capacidad restante de la bomba", Toast.LENGTH_SHORT).show();
            return;
        }
